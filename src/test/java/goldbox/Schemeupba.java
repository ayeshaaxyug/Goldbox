...
public class Schemeupba {
	...
	public void Schemeupba () throws Exception 
	{
        ...
        WebElement dropdownElement10 = driver.findElement(By.xpath("//select[@formcontrolname='amount']"));

        // Create a Select object from the dropdown element
        Select dropdown10 = new Select(dropdownElement10);

        // Select an option by visible text
        dropdown10.selectByVisibleText("1000");
